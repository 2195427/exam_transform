...
class FileTransformController{
    ...
    function index($action, $params, $payload){
        ...
        echo "</br>";
        echo 'To download the tranformed exam sheet for students to press <a href="http://localhost/pegasus_paraphrase/exammvc/temp/trans'.$action.'">Students Copy</a>';
        echo "</br>";
        echo 'To download the tranformed exam sheet with answer to press <a href="http://localhost/pegasus_paraphrase/exammvc/temp/teachtrans'.$action.'">Professor Copy</a>';
        echo "</br>";
        echo "</br>";
        $target_dir = "temp/";
                ...
                switch ($segnum) {
                    case 0:
                        ...
                        $detail=$id.'.'.$str;
                           ...
                           //$str_after_transform=system("python ../pegasusPara.py $str2");
                           exec("python ../pegasusPara.py $str2",$str_after_transform, $res);
